...
public class Graph<Type> {
    ...
    /**
     * This method uses the depthFirstSearch algorithm learned in lecture and calls the helper depthFirstSeatchHelper on the starting vertex.
     * Sets the distance from the start to the starting vertex to 0. Sets the distance of the vertex from the start  to infinity
     * @param s
     */
    ...
    /**
     * This method sets the distance from start of the vertex to the distance from the start of the starting vertex + 1. Sets the previous vertex of the currrent vertex
    ...
    /**
     * This method finds the shortest path from the vertex of srcData to the vertex of dstData using breadth first search
...
/**
 * This method adds the data of the current vertex to the path if current isn't null and sets current equal to the current vertex of previousVertices
 * 
